...
$(call MXCPP_RUN_COMMAND,$($(MXCPP_COMPILER_TYPE)) $(if $(strip $($(MXCPP_COMPILER_TYPE)_USE_RESPONSE_FILE)),@$(MXCPP_RESPONSE_FILE),$(MXCPP_COMPILE_RULE)),,\
		$(if $(strip $(MXCPP_WARNING_LOG)),$($(MXCPP_COMPILER_TYPE)_WARNING_FILE)>>$(MXCPP_WARNING_LOG)))
...
$(eval MXCPP_BUILD_RULE := $$(call MXCPP_BUILD_EXE,$(LNKC_OBJ)$(MXCPP_OBJECT),,$(MXCPP_LIBS) $(MXCPP_BUILD_LIBS),$(5),$(6)))
...
$(eval MXCPP_BUILD_EXTRA_FLAGS := $(if $(strip $(CXXFLAGS_DLL_DLL)),$(CXXFLAGS_DLL_DLL) )$(CXX_DEFINE)MXCPP_MAKEDLL),\
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_start_$(MXCPP_BUILD_RULES_SRC),,X)
	...
	$(if $(strip $(MXCPP_WARNING_LOG)),@$(ECHO) Building $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_WARNING_LOG))
	$(if $(strip $(MXCPP_COMMANDS_LOG)),@$(ECHO) Building $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_COMMANDS_LOG))
...
$(if $(strip $(MXCPP_DLLCONFIG_$(1))),\
$(eval MXCPP_BUILD_EXTRA_FLAGS := $(if $(strip $(CXXFLAGS_DLL_EXE)),$(CXXFLAGS_DLL_EXE) )$(CXX_DEFINE)MXCPP_USEDLL),\
$(eval MXCPP_BUILD_EXTRA_FLAGS :=))
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_start_test_$(MXCPP_BUILD_RULES_SRC),,X)
	...
	$(if $(strip $(MXCPP_TEST_LOG)),@$(ECHO) Testing $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_TEST_LOG))
	$(if $(strip $(MXCPP_COMMANDS_LOG)),@$(ECHO) Testing $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_COMMANDS_LOG))
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_start_clean_$(MXCPP_BUILD_RULES_SRC),,X)
	...
	$(if $(strip $(MXCPP_COMMANDS_LOG)),@$(ECHO) Cleaning $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_COMMANDS_LOG))
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_start_cleanall_$(MXCPP_BUILD_RULES_SRC),,X)
	...
	$(if $(strip $(MXCPP_COMMANDS_LOG)),@$(ECHO) Cleaning all $(MXCPP_BUILD_RULES_LIBRARY)[$(MXCPP_BUILD_RULES_CONFIGURATION)] ...>>$(MXCPP_COMMANDS_LOG))
...
$(if $(strip $(MXCPP_WARNING_LOG)),$(call MXCPP_RUN_COMMAND,$(RM) $(MXCPP_WARNING_LOG),-,$(NOERROUT)))
