...
$(eval MXCPP_BUILD_RULES_CONFIGURATION_COMMA := $(subst $(MXCPP_EMPTY_SPACE),$(MXCPP_COMMA),$(MXCPP_BUILD_RULES_LIBRARY) $(MXCPP_BUILD_RULES_CONFIGURATION)))
...
$(eval MXCPP_OBJ_LIST :=)
$(foreach srcfile,$(MXCPP_SRC_LIST),$(call MXCPP_BUILD_RULES_OBJECT,$(srcfile),$(MXCPP_OBJECT_DIR),$(MXCPP_BUILD_RULES_CONFIGURATION_COMMA)))
