...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,$(if $(strip $(MXCPP_BUILD_RULES_SRC)),test$(3)$(MXCPP_BUILD_RULES_SRC) $(MXCPP_BUILD_RULES_SRC)$(3)test,test),$(MXCPP_BUILD_RULES_SRC) test_$(MXCPP_BUILD_RULES_TGT),$(4))
$(if $(strip $(3)),,$(call MXCPP_BUILD_RULES_SINGLE_RULE,test_$(MXCPP_BUILD_RULES_SRC) $(MXCPP_BUILD_RULES_SRC)_test,$(MXCPP_BUILD_RULES_SRC) test_$(MXCPP_BUILD_RULES_TGT),$(4)))
...
$(eval MXCPP_OBJ_LIST :=)
$(foreach srcfile,$(MXCPP_SRC_LIST),$(eval $(call MXCPP_BUILD_RULES_OBJECT,$(srcfile),$(MXCPP_OBJECT_DIR))))
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,$(MXCPP_BUILD_RULES_SRC),_start_$(MXCPP_BUILD_RULES_SRC) $(MXCPP_TARGET_LIBRARY) _end_$(MXCPP_BUILD_RULES_SRC),X)
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_end_$(MXCPP_BUILD_RULES_SRC),,X)
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,test_$(MXCPP_BUILD_RULES_SRC) $(MXCPP_BUILD_RULES_SRC)_test,$(MXCPP_BUILD_RULES_SRC) _start_test_$(MXCPP_BUILD_RULES_SRC) _end_test_$(MXCPP_BUILD_RULES_SRC),X)
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_end_test_$(MXCPP_BUILD_RULES_SRC),,X)
	@$(ECHO) ... testing $(MXCPP_BUILD_RULES_LIBRARY)($(MXCPP_BUILD_RULES_CONFIGURATION)) done.

$(call MXCPP_BUILD_RULES_SINGLE_RULE,clean_$(MXCPP_BUILD_RULES_SRC),_start_clean_$(MXCPP_BUILD_RULES_SRC) _make_clean_$(MXCPP_BUILD_RULES_SRC) _end_clean_$(MXCPP_BUILD_RULES_SRC),X)
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_end_clean_$(MXCPP_BUILD_RULES_SRC),,X)
	@$(ECHO) ... cleaning $(MXCPP_BUILD_RULES_LIBRARY)($(MXCPP_BUILD_RULES_CONFIGURATION)) done.

$(call MXCPP_BUILD_RULES_SINGLE_RULE,cleanall_$(MXCPP_BUILD_RULES_SRC),_start_cleanall_$(MXCPP_BUILD_RULES_SRC) _make_cleanall_$(MXCPP_BUILD_RULES_SRC) _end_cleanall_$(MXCPP_BUILD_RULES_SRC),X)
...
$(call MXCPP_BUILD_RULES_SINGLE_RULE,_end_cleanall_$(MXCPP_BUILD_RULES_SRC),,X)
...
$(call MXCPP_BUILD_RULES_GROUP,$(1),$(1) $(2),_,1)

$(foreach dbitype,$(MXCPP_TARGET_SUBTYPE_DBGINFO),$(call MXCPP_BUILD_RULES_SHARE_CHARTYPE_DBGINFO,$(1),$(2),$(dbitype)))
